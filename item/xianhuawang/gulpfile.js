...
gulp.task("copy-html",function () {
    return gulp.src('*.html')
        .pipe(gulp.dest('D:\\phpStudy\\WWW\\xianhuawang'));
});
...
gulp.task('copy-images',function(){
    return gulp.src('img/*.{jpg,png,tmp,gif}')
        .pipe(gulp.dest('D:\\phpStudy\\WWW\\xianhuawang\\img'));
});
...
gulp.task('copy-css', function(){
    return gulp.src('css/*.css')
        .pipe(sass())
        .pipe(gulp.dest('D:\\phpStudy\\WWW\\xianhuawang\\css'));
});
...
gulp.task('copy-js',function(){
    return gulp.src('js/*.js')
        .pipe(gulp.dest('D:\\phpStudy\\WWW\\xianhuawang\\js'));
});
...
gulp.task('copy-php',function(){
    return gulp.src('php/*.php')
        .pipe(gulp.dest('D:\\phpStudy\\WWW\\xianhuawang\\php'));
});

//font
gulp.task('copy-font',function(){
    return gulp.src('font/**')
        .pipe(gulp.dest('D:\\phpStudy\\WWW\\xianhuawang\\font'));
});
